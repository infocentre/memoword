...
(function (name, definition) {
  ...
  var TTS = function (defaultLanguage) {
    ...
    self.addPlayer = function (pm) {
      if (!(pm instanceof TTS.Player)) { throw new Error('Must be a instance of base Player class') }
    ...
    self.urls = function (txt, lang) {
      ...
      if (!txt || txt.length <= 0) { throw new Error('Need some text') }
  ...
  TTS.HTML5Player = function () {
    ...
    self.available = function (cb) {
      if (self._available === null) {
        ...
        (function (next) {
          try {
            if (typeof window.Audio === 'undefined') { return next(null, false) }
            ...
            if (audio.canPlayType('audio/mpeg') === 'probably') { return next(null, true) }
  ...
  TTS.SM2Player = function () {
    ...
    self.available = function (cb) {
      if (self._available === null) {
        if (typeof window.soundManager !== 'undefined' && typeof window.soundManager.ok === 'function') {
